...
@Component({
  selector: 'app-pagina-contataore-earticoli',
  templateUrl: './pagina-contataore-earticoli.component.html',
  styleUrls: ['./pagina-contataore-earticoli.component.scss']
})
export class PaginaContataoreEArticoliComponent {
  count = 0;
  articoli: IArticle[] = [];
  items = ['pippo', 'pluto']
